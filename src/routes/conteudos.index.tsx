...
const insights: Insight[] = [
  { theme: "Tributário", kind: "Análise", h: "Recuperação Tributária para Clínicas: Como Funciona o PER/DCOMP", b: "Entenda a sequência técnica de retificação, apuração e transmissão do PER/DCOMP para recuperar tributos pagos a maior por clínicas médicas e odontológicas.", to: "/conteudos/recuperacao-tributaria-clinicas-perdcomp", date: "Set 2026" },
  ...
  { theme: "Tributário", kind: "Análise", h: "Glosa de Credito de IBS e CBS: Principais Causas e Como Evitar", b: "A glosa de credito de IBS/CBS pode gerar cobranca retroativa, juros e multa. Entenda as principais causas e como estruturar controles preventivos.", to: "/conteudos/glosa-credito-ibs-cbs-causas-como-evitar", date: "Set 2026" },
  ...
  { theme: "Tributário", kind: "Análise", h: "Simples Nacional vai acabar em 2027? O que realmente muda", b: "A desinformação sobre o fim do Simples Nacional está gerando pânico desnecessário. Entenda o que realmente muda em 2027 e o que continua igual.", to: "/conteudos/simples-nacional-vai-acabar-2027", date: "Set 2026" },
  { theme: "Tributário", kind: "Análise", h: "Folha de Pagamento Gera Crédito de IBS e CBS?", b: "Salários e encargos não geram crédito de IBS/CBS. Entenda por que, o que isso significa para prestadores de serviço, e o que NÃO deve ser confundido com folha.", to: "/conteudos/folha-pagamento-credito-ibs-cbs", date: "Set 2026" },
  { theme: "Tributário", kind: "Análise", h: "Aluguel, Software e Serviços: Quando Há Crédito de IBS e CBS", b: "Aluguel comercial tem regra própria de crédito, e a documentação do locador pode definir se você recupera esse crédito ou não. Entenda também software e serviços contratados.", to: "/conteudos/aluguel-software-servicos-credito-ibs-cbs", date: "Set 2026" },
  ...
  { theme: "Tributário", kind: "Análise", h: "IBS e CBS com Aliquota Reduzida: Setores Beneficiados e Creditos", b: "Entenda quais atividades terao reducao de IBS e CBS, como funcionara o aproveitamento dos creditos, quais setores podem ser beneficiados e os riscos de glosa e enquadramento.", to: "/conteudos/ibs-cbs-aliquota-reduzida-setores-beneficiados", date: "Set 2026" },
  ...
  { theme: "Defesa fiscal", kind: "Análise", h: "Dívida Ativa da União: quando o débito vai para a PGFN", b: "Entenda quando débitos vencidos há mais de 90 dias podem ser encaminhados à PGFN, os riscos da entrada de 10%/20% no reparcelamento e como funciona a Dívida Ativa da União.", to: "/conteudos/divida-ativa-uniao-encaminhamento-pgfn", date: "Set 2026" },
  { theme: "Defesa fiscal", kind: "Análise", h: "LC 236/2026: as novas regras nacionais do processo administrativo fiscal", b: "Teto de multa, reduções por antecipação, prazos processuais unificados, inscrição em dívida ativa, duplo grau e súmulas vinculantes.", to: "/conteudos/lc-236-2026-processo-administrativo-fiscal", date: "Set 2026" },
