...
const insights: Insight[] = [
  ...
  { theme: "Patrimônio", kind: "Análise", h: "Holding patrimonial: quando vale e quando é mito", b: "Estrutura societária, ITCMD e governança familiar com base técnica.", to: "/conteudos/holding-patrimonio", date: "Mai 2026" },
  { theme: "Patrimônio", kind: "Briefing", h: "Sucessão em vida: doação, usufruto e cláusulas", b: "Decisões que reduzem litígio e custo de transmissão.", to: "/conteudos/holding-patrimonio", date: "Abr 2026" },
