    ...
    scripts: [
      {
        ...
        children: JSON.stringify({"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Início", "item": "/"}, {"@type": "ListItem", "position": 2, "name": "Segmentos", "item": "/segmentos"}, {"@type": "ListItem", "position": 3, "name": "Pendências Fiscais", "item": "/segmentos/pendencias-fiscais"}]}),
      },
    ],
  }),
  component: Page,
...
function Page() {
  return (
    <PageScaffold
      ...
      intro="Contabilidade técnica desenhada para a realidade tributária e operacional de empresas com pendências fiscais."
      intent="empresa com dívida fiscal, regularizar Receita Federal"
      observation="Dor extrema — alta conversão."
      ctaPrimary={{ label: "Solicitar diagnóstico", to: "/diagnostico" }}
      ctaSecondary={{ label: "Falar com a DCON", to: "/contato" }}
      sections={[
      { h2: "Particularidades tributárias e contábeis", h3: [{"title":"Tributação específica","body":"Regras fiscais que afetam diretamente operações de empresas com pendências fiscais."},{"title":"Obrigações próprias","body":"Acessórias e declarações típicas deste segmento."},{"title":"Risco mais comum","body":"O erro que mais vemos neste tipo de operação."}] },
