...
function Page() {
  return (
    <PageScaffold
      ...
      intro="Contabilidade técnica desenhada para a realidade tributária e operacional de lucro presumido."
      intent="Lucro Presumido, presunção PIS COFINS"
      observation="Intenção comercial."
      ctaPrimary={{ label: "Solicitar diagnóstico", to: "/diagnostico" }}
      ctaSecondary={{ label: "Falar com a DCON", to: "/contato" }}
      sections={[
      { h2: "Particularidades tributárias e contábeis", h3: [{"title":"Tributação específica","body":"Regras fiscais que afetam diretamente operações de lucro presumido."},{"title":"Obrigações próprias","body":"Acessórias e declarações típicas deste segmento."},{"title":"Risco mais comum","body":"O erro que mais vemos neste tipo de operação."}] },
