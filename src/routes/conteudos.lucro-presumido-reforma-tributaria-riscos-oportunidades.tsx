    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Lucro Presumido na Reforma Tributária: riscos e oportunidades", item: "https://dcon.cnt.br/conteudos/lucro-presumido-reforma-tributaria-riscos-oportunidades/" },
          ],
        }),
      },
      {
