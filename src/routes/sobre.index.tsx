      ...
      },
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 2, name: "Sobre", item: "https://dcon.cnt.br/sobre/" },
          ],
        }),
      },
    ],
...
function Page() {
  return (
    <PageScaffold
      ...
      ctaSecondary={{ label: "Conhecer a metodologia", to: "/metodo" }}
      sections={[
