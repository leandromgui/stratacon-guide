    ...
    scripts: [
      {
        ...
        children: JSON.stringify({"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Início", "item": "https://dcon.cnt.br/"}, {"@type": "ListItem", "position": 2, "name": "Soluções", "item": "https://dcon.cnt.br/solucoes/"}]}),
      },
    ],
  }),
  component: Page,
...
function Page() {
  return (
    <PageScaffold
      ...
      { h2: "Liderança técnica por trás das soluções", lead: "Toda solução consultiva da DCON é conduzida sob a liderança técnica de Leandro Matsuoka Guimarães, contador CRC-GO 16.395/O-9, sócio da DCON, formado em Ciências Contábeis, bacharel em Direito e pós-graduado em Controladoria e Finanças Corporativas.", h3: [{"title":"Atuação integrada","body":"Planejamento tributário, recuperação de créditos, análise de regimes, regularização, defesas administrativas, SPED, holdings, indicadores e suporte a decisões de crescimento, sucessão e reorganização."},{"title":"Método e rastreabilidade","body":"Cada entrega tem documentação, fundamento e coerência entre operação real, notas fiscais, escrituração, obrigações acessórias e decisões da administração."},{"title":"Contabilidade consultiva","body":"O papel do responsável técnico é assegurar que cada solução subsidie decisão, não apenas cumpra obrigação acessória."}] },
      ]}
    />
  );
}
