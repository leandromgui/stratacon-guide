    ...
    scripts: [
      {
        ...
        children: JSON.stringify({
          ...
          itemListElement: [
            ...
            { "@type": "ListItem", position: 3, name: "Auditoria de Fornecedores para Preservar Créditos de IBS e CBS", item: "https://dcon.cnt.br/conteudos/auditoria-fornecedores-creditos-ibs-cbs/" },
          ],
        }),
      },
      {
