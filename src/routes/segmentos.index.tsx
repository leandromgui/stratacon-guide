...
export const Route = createFileRoute("/segmentos/")({
  head: () => ({
    ...buildSeoHead({
      ...
      canonical: "https://dcon.cnt.br/segmentos",
    }),
    scripts: [
      {
        type: "application/ld+json",
        children: JSON.stringify({"@context": "https://schema.org", "@type": "BreadcrumbList", "itemListElement": [{"@type": "ListItem", "position": 1, "name": "Início", "item": "https://dcon.cnt.br/"}, {"@type": "ListItem", "position": 2, "name": "Segmentos", "item": "https://dcon.cnt.br/segmentos/"}]}),
      },
    ],
  }),
  component: Page,
...
function Page() {
  return (
    <PageScaffold
      ...
      { h2: "Comércio e digital", h3: [{"title":"E-commerce e marketplaces","body":"DIFAL, ICMS-ST e operação multiestadual sob controle."},{"title":"Comércio varejista","body":"ICMS-ST e fluxo de notas com revisão preventiva."},{"title":"Atacadistas e distribuidores","body":"Lucro Real, revisão de NCM, ICMS, PROTEGE e créditos de IBS e CBS analisados produto a produto."},{"title":"Tecnologia e startups","body":"Operações SaaS, ISS, equity e Lei do Bem."}] },
