...
export const categories: CategoryDef[] = [
  {
    ...
    articles: [
      ...
      { h2: "IBS e CBS com Alíquota Reduzida: Setores Beneficiados e Créditos", excerpt: "Entenda quais atividades terão redução de IBS e CBS, como funcionará o aproveitamento dos créditos, quais setores podem ser beneficiados e os riscos de glosa e enquadramento.", to: "/conteudos/ibs-cbs-aliquota-reduzida-setores-beneficiados", kind: "Análise", date: "Set 2026" },
