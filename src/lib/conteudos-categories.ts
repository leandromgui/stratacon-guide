...
export const categories: CategoryDef[] = [
  {
    ...
    articles: [
      { h2: "Recuperação Tributária para Clínicas: Como Funciona o PER/DCOMP", excerpt: "Entenda a sequência técnica de retificação, apuração e transmissão do PER/DCOMP para recuperar tributos pagos a maior por clínicas médicas e odontológicas.", to: "/conteudos/recuperacao-tributaria-clinicas-perdcomp", kind: "Análise", date: "Set 2026" },
      { h2: "Benefício Fiscal para E-commerce em Goiás: TARE e ICMS", excerpt: "Entenda o crédito outorgado para e-commerce em Goiás, a carga própria de ICMS, os requisitos do TARE, investimentos, DIFAL e riscos fiscais.", to: "/conteudos/beneficio-fiscal-ecommerce-goias", kind: "Análise", date: "Set 2026" },
      { h2: "Revisão de Contratos para IBS e CBS: cláusulas essenciais", excerpt: "Contratos de longo prazo sem cláusula de revisão tributária podem obrigar sua empresa a absorver o aumento de carga da Reforma. Veja o que revisar.", to: "/conteudos/revisao-contratos-ibs-cbs-clausulas-essenciais", kind: "Análise", date: "Set 2026" },
      { h2: "Prestadores de Serviços na Reforma Tributária: poucos créditos e mais pressão", excerpt: "A folha de pagamento está fora da incidência da CBS. Entenda por que prestadores de serviço B2B sentem mais pressão de margem na Reforma Tributária.", to: "/conteudos/prestadores-servicos-reforma-tributaria-poucos-creditos", kind: "Análise", date: "Set 2026" },
      { h2: "Auditoria de Fornecedores para Preservar Créditos de IBS e CBS", excerpt: "Na não cumulatividade do IBS/CBS, o crédito da sua empresa depende da regularidade fiscal do fornecedor. Veja como auditar sua cadeia para não perder crédito.", to: "/conteudos/auditoria-fornecedores-creditos-ibs-cbs", kind: "Análise", date: "Set 2026" },
      ...
      { h2: "IBS e CBS com Aliquota Reduzida: Setores Beneficiados e Creditos", excerpt: "Entenda quais atividades terao reducao de IBS e CBS, como funcionara o aproveitamento dos creditos, quais setores podem ser beneficiados e os riscos de glosa e enquadramento.", to: "/conteudos/ibs-cbs-aliquota-reduzida-setores-beneficiados", kind: "Análise", date: "Set 2026" },
      { h2: "Lucro Real na Reforma Tributária: créditos, controles e risco fiscal", excerpt: "Empresas do Lucro Real já operam no regime não cumulativo de PIS/Cofins. Entenda por que a transição para a CBS tende a ser mais previsível, mas exige mais controle.", to: "/conteudos/lucro-real-reforma-tributaria-creditos-controles", kind: "Análise", date: "Set 2026" },

      { h2: "Lucro Presumido na Reforma Tributária: riscos e oportunidades", excerpt: "Entenda como a CBS substitui o PIS/Cofins cumulativo no Lucro Presumido, por que prestadores de serviço sentem mais o impacto, e o que a LC 224/2025 já mudou.", to: "/conteudos/lucro-presumido-reforma-tributaria-riscos-oportunidades", kind: "Análise", date: "Set 2026" },
      ...
      { h2: "Simples Nacional vai acabar em 2027? O que realmente muda", excerpt: "A desinformação sobre o fim do Simples Nacional está gerando pânico desnecessário. Entenda o que realmente muda em 2027.", to: "/conteudos/simples-nacional-vai-acabar-2027", kind: "Análise", date: "Set 2026" },
      { h2: "Folha de Pagamento Gera Crédito de IBS e CBS?", excerpt: "Salários e encargos não geram crédito de IBS/CBS. Entenda por que, o que isso significa para prestadores de serviço, e o que NÃO deve ser confundido com folha.", to: "/conteudos/folha-pagamento-credito-ibs-cbs", kind: "Análise", date: "Set 2026" },
      { h2: "Aluguel, Software e Serviços: Quando Há Crédito de IBS e CBS", excerpt: "Aluguel comercial tem regra própria de crédito, e a documentação do locador pode definir se você recupera esse crédito ou não. Entenda também software e serviços contratados.", to: "/conteudos/aluguel-software-servicos-credito-ibs-cbs", kind: "Análise", date: "Set 2026" },
      ...
      { h2: "Planejamento tributário: elisão x evasão", excerpt: "Onde está a fronteira jurídica entre economia legítima e risco de autuação.", to: "/solucoes/planejamento-tributario", kind: "Análise", date: "Abr 2026" },
      { h2: "ICMS-ST e DIFAL para operações interestaduais", excerpt: "Como operar entre estados sem acumular passivo silencioso.", to: "/segmentos/comercio", kind: "Guia", date: "Abr 2026" },
  ...
  },
  {
    ...
    articles: [
      ...
      { h2: "Pendências fiscais por segmento", excerpt: "Roteiro setorial para sair do passivo fiscal de forma estruturada.", to: "/solucoes/regularizacao-fiscal", kind: "Análise", date: "Mar 2026" },
  ...
  },
  {
    ...
    articles: [
      ...
      { h2: "Holding patrimonial — aprofundamento", excerpt: "Análise técnica completa de estrutura, custos e governança.", to: "/solucoes/holding-patrimonial", kind: "Estudo", date: "Mai 2026" },
  ...
  },
  {
    ...
    articles: [
      { h2: "PJ x CLT: risco de vínculo e estruturação correta", excerpt: "Critérios objetivos, jurisprudência recente e desenho seguro.", to: "/solucoes/departamento-pessoal", kind: "Guia", date: "Mar 2026" },
      { h2: "Pró-labore: como definir tecnicamente", excerpt: "Impacto previdenciário, IRPF do sócio e distribuição de lucros.", to: "/solucoes/departamento-pessoal", kind: "Análise", date: "Fev 2026" },
      { h2: "DP e eSocial — visão completa", excerpt: "Rotina, eventos e cuidados na operação do departamento pessoal.", to: "/solucoes/departamento-pessoal", kind: "Estudo", date: "Fev 2026" },
  ...
  },
  {
    ...
    articles: [
      ...
      { h2: "ICMS-ST e DIFAL no e-commerce", excerpt: "Operação multiestadual sem acumular passivo silencioso.", to: "/segmentos/comercio", kind: "Guia", date: "Abr 2026" },
